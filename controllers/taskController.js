...
// // exports.createTask = async (req, res) => {
// //   try {
// //     // const { title, completed, priority, dayOfWeek } = req.body;
// //     const { title, dayOfWeek } = req.body;
// //     // const newTask = new Task({ title, completed, priority, dayOfWeek, user: req.user.id });
// //     const newTask = new Task({ title,dayOfWeek, user: req.user.id });
// //     const savedTask = await newTask.save();
// //     res.status(201).json(savedTask);
// //   } catch (error) {
// //     console.error(error);
